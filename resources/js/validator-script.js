...
// validation rules
WinPos.Validator.types.isNonEmpty = {
...
WinPos.Validator.types.isBDPhoneNumber = {
...
WinPos.Validator.types.isEmail = {
...
WinPos.Validator.types.isAlphaNumericAndUnderscore = {
    validate: function(value){
...
WinPos.Validator.types.isAlphaNumericAndUnderscoreExpenseName = {
    validate: function(value){
        return /^[A-Za-z][A-Za-z0-9 ]{2,49}$/.test(value);
    },
...
WinPos.Validator.types.isLessThanNextDay = {
    validate: function(value){
...
WinPos.Validator.types.isMoney = {
    validate: function(value){
