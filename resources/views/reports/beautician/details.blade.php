                        ...
                        <table class="table table-bordered" id="reportTable">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-right align-middle" style="width: 8%;" scope="col">Negative Review</th>
                                    <th class="text-right align-middle" style="width: 8%;" scope="col">TOT Service</th>
                                    <th class="text-right align-middle" style="width: 8%;" scope="col">AVG Service</th>
                                </tr>
                            </thead>
                            <tbody>
                            </tbody>
