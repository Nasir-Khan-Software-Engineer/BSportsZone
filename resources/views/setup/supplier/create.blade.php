                    ...
                    <div class="form-row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control rounded" id="supplierPhone" placeholder="Enter supplier phone number" name="phone" required value="{{isset($supplier)?$supplier->phone:""}}">
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
