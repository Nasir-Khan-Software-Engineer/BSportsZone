...
class EmployeeSmsReportAccessRightSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $accessRights = [
            ...
            [
                'title' => 'Reports->Beautician-> View Beautician Report',
                'route_name' => 'reports.beautician.details',
                'short_id' => 'report_beautician_details',
                'description' => 'Allows viewing beautician report',
            ],
            [
                'title' => 'Reports->Beautician-> Download Beautician Report',
                'route_name' => 'reports.beautician.details.download',
                'short_id' => 'report_beautician_download',
                'description' => 'Allows downloading beautician report',
            ],
            [
